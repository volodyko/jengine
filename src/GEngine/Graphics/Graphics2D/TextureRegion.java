 ...
 * @author mzechner
 * @author Nathan Sweet */
public class TextureRegion implements ITexture2D {
	...
	public TextureRegion(Texture2D texture, int x, int y) {
	...
	public void set(Texture2D texture, float u, float v, float u2, float v2) {
