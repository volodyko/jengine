...
import GEngine.Core.Math.Vector2f;
...
public class Input {
    ...
    public static int NUM_MOUSEBUTTONS = org.lwjgl.input.Mouse.getButtonCount();
    ...
    {
        return new Vector2f(org.lwjgl.input.Mouse.getX(),Window.getHeight()-org.lwjgl.input.Mouse.getY()-1);
    }
    ...
    /**
     *Return mouse wheel rolling
     * @return -1 if wheel rolled Up, 1 if Down, if idle 0  
     */
    public static int checkMouseWheel() 
    {
